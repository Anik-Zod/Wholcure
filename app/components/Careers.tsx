    ...
    return (
        <section id="careers" className="py-24 bg-white relative overflow-hidden">
            <div className="container max-w-7xl mx-auto px-8">
                ...
                <div className="mb-20">
                    <h3 className="text-3xl font-bold mb-10 text-center text-primary">Why Work With Us?</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {benefits.map((benefit, idx) => (
                            <div key={idx} className="text-center p-8 bg-bg-light rounded-2xl transition-all duration-300 hover:-translate-y-2 hover:bg-white hover:shadow-custom-md">
                                <i className={`fas ${benefit.icon} text-5xl text-primary mb-6`}></i>
                ...
                <div>
                    <h3 className="text-3xl font-bold mb-10 text-center text-primary">Current Openings</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {jobs.map((job, idx) => (
                            <div key={idx} className="border border-border p-8 rounded-2xl transition-all duration-300 hover:-translate-y-2 hover:shadow-custom-md bg-white hover:border-primary">
                                ...
                                <div className="flex justify-between items-center pt-4 border-t border-border">
                                    ...
                                    <button className="px-6 py-2 bg-gradient-primary text-white rounded-xl font-semibold transition-transform duration-300 hover:-translate-y-1 hover:shadow-custom-md" onClick={() => openModal(job.title)}>Apply Now</button>
                                </div>
                            </div>
                        ))}
                    </div>
